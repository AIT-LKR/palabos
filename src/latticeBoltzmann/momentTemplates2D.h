...
// template<typename T>
// struct momentTemplatesImpl<T, descriptors::D2Q5DescriptorBase<T> > {
// 
...
// // has to be changed
// static T get_eBar(Array<T,Descriptor::q> const& f) {
//     T eBar = (T) 0.; // (T)2 * (f[1] + f[3] + f[5] + f[7]) + f[2] + f[4] + f[6] + f[8];
//     return eBar;
// }
// 
// 
...
// }
// 
// };  //struct momentTemplatesImlp<D2Q5DescriptorBase>
}  // namespace plb
